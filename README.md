...
# Workflow schedules
Determine and refine the plan in the early stage, make textures for the model in the middle stage, compose the video and create effects in the later stage, overview the preliminary work and the plan, and finalize the plan in the later stage.
...
# Project features:
## Function 1: Map tour of West Lake
Guided tour overview: Locations: 1, Musical Fountain, ----, 2, Three Pools, Reflecting the Moon, -----, 3, Leifeng Pagoda, -----, 4, Broken Bridge------- 5, Su Causeway
...
## Function 2: Interactive display at a fixed location
1. Musical Fountain (interactive display): Goldfish migrate, and goldfish shuttle through the water column with music.
2. Three Pools of the Moon: Portal: Immersive viewing, find clues in the door to solve the mystery.
3. Leifeng Pagoda (Multiplayer Interactive): Help Fahai suppress the White Snake.
4. Broken Bridge: Su Shi broke the bridge and slashed the demon, and the player turned into a swordsman to split the evil in the air with the sword in his hand
5. Su Causeway: Su Shi repairs the embankment, and the player collects the soil in his hand and throws it at the embankment to complete the repair.



Feature 3 Storytelling to bring in
This project takes Su Shi's first perspective to experience and visit the West Lake, takes Su Shi's life story as the main line, and takes an amnesiac person as the perspective to find his own life experience. The ICON of the five point feature information is suspended on the sandbox, and the finger touches it to appear information about the point story, as well as the point information, and the navigation content.
...
# Long-term goals:
Improve the interactive experience of the sand table, interactive logo, sound effect characteristics, etc.
The guided sand table has functional features and a new experience.
Click on the geolocation icon, the realistic cursor will appear in the sandbox and the navigation cursor will appear on the actual ground, guiding you to the corresponding experience location. Improve the output navigation sandbox, navigation content and navigation accuracy.
The big data collection and content navigation of West Lake information convey more information and stories about West Lake to experiencers.
Deliver a complete story line based on Su Shi.
The reasonable allocation of the story and each point, and the interesting interactive explanation (interactive refinement on the existing outline).
Convey the proper message in an interesting and vivid way.
The output of the corresponding entity can identify the AR interaction around the linkage with the merchant.
...
# Short-term goals
1. Goal 1: Navigate the construction of sandbox assets
• Task 1: Refer to the visual style of the game and traditional Chinese elements, find references, and make preliminary plans.
• Task 2: Make corresponding art assets and icon logos according to the characteristics of West Lake (Five Scenes).
• Mission 3: Build a concentrated sand table of the geographical features of West Lake.
• Task 4: Refine the content of art assets (3D, smooth operation, visual mode feeling, stylized features, etc.), build the outer ring elements of the sand table to deepen the national style information.
...
2. Objective 2: Interact with the navigation sandbox 
• Task 1: Import AR, consider the actual experience after the build, and adjust the specific location and size of the assets inside the sandbox
• Task 2: Add a cutout for portrait recognition, so that the device can recognize the person, and cut out the portrait on the AR asset without occlusion.





• Task 3: Gesture recognition, touch the icon of the sand table will pop up the geographic information of the corresponding point, story guide, and AR interactive experience.
• Mission 4: Click on the geolocation icon to display the reality cursor in the sandbox and the navigation cursor on the actual ground to guide you to the corresponding experience location.




3. Objective 3: Demonstrate video capture and production
### Task 1: Investigate the flow of people and weather conditions in the corresponding area, and choose a time and place with less people and more light in a short period of time.
...
• Expected result 2: Outputs stylized accordingly.
• Expected result 3: Functional attributes finalized.
2. Milestone 2 (4.15): Improve the art assets of the West Lake Guided Sand Table
• Expected Outcome 1: Build a stylized Chinese sand table according to the characteristics of West Lake (the game is built with Chinese style art assets, stylized white molds, and UV materials are displayed and textured. ）
• Expected result 2: Icons of the five corresponding features produced.
• Expected Outcome 3: Art assets are built into the mobile phone and run smoothly (the blender model is minus).
3. Milestone 3 (4.18): Post-Interaction Clarification Added
• Expected Outcome 1: Unity's built-in plug-in recognizes and deducts portraits in AR
• Expected Outcome 2: Added touch to the gesture recognition part of the Holokit SDK (added a touchable volume for thumbs up and hidden visual squares, and a UI interface that displays the corresponding story text and interaction method after touching the icon touch volume.)
...
4. Milestone 4 (4.21): Demonstrate video production and production
• Expected Outcome 1: Demonstrate the AR West Lake Guided Sand Table art assets and their actual functionality
